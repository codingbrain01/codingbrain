      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            {/* Education card */}
            <div className="p-5 rounded-xl border border-[#2a2a38] bg-[#111118]">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs mt-0.5">{education.specialization}</p>
          ...
          >
            {stats.map(({ icon, value, label }, i) => (
              <motion.div
                ...
                className="p-6 rounded-xl border border-[#2a2a38] bg-[#111118] hover:border-indigo-500/30 transition-colors group"
              >
                <div className="text-indigo-400 mb-3 group-hover:scale-110 transition-transform w-fit">
                  {icon}
                </div>
