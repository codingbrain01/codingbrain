...
export const projects = [
  ...
  {
    id: 'google-sheets-form-pipeline',
    featured: true,
    badge: 'Featured',
    title: 'Google Sheets Form Pipeline',
    tagline: 'Google Sheets API · TypeScript · Automation · Lead Tracking',
    description:
      'A project form submission workflow that captures client inquiries and automatically syncs structured lead data into Google Sheets. Built for fast follow-up, simple reporting, and lightweight CRM-style organization without adding a full database dashboard.',
    highlights: [
      'Connected project forms directly to Google Sheets for real-time lead capture',
      'Structured submissions into clean rows for tracking, follow-up, and reporting',
      'Reduced manual copy-paste work through automated form-to-sheet delivery',
      'Designed as a lightweight CRM foundation that can expand into dashboards or notifications',
    ],
